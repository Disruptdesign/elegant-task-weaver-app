  ...
  if (items.length === 0) {
    return (
      <div className="text-center py-12 sm:py-16 bg-white rounded-2xl border border-gray-100 shadow-sm">
        <div className="mx-auto w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-br from-blue-50 to-purple-50 rounded-full flex items-center justify-center mb-6 animate-pulse">
          {hasActiveFilters ? (
        ...
        {!hasActiveFilters && (
          <Button
            onClick={onAddNew}
            className="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-105 touch-target"
            size="lg"
          >

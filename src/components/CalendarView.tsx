...
export function CalendarView({ 
  ...
  return (
    <div className="flex flex-col h-full">
      {/* En-tête fixe */}
      <div className="flex-shrink-0 space-y-6 p-4 lg:p-8 border-b border-gray-200 bg-white">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => {
                const amount = viewMode === 'week' ? 7 : 30;
                const newDate = addDays(currentDate, -amount);
                setCurrentDate(newDate);
              }}
      ...
      <div className="flex-1 p-4 lg:p-8 overflow-hidden">
        {viewMode === 'week' ? (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden h-full flex flex-col">
            ...
            {/* Grille horaire - Défilable pour toute la hauteur restante */}
          ...
          // Vue mois - Reste défilable normalement
